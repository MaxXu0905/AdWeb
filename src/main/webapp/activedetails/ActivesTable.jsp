...
<body data-spy="scroll" data-target=".bs-docs-sidebar"
	...
	<div
		...
		<table style="font-size:12px">
			<tr>
				<td><span style="margin-right:10px">参与者手机号码</span>
				</td>
				<td><input type="text" id="oPhoneNumber" />
				</td>
				<td><span style="margin-right:10px;margin-left:20px">活动ID</span>
				</td>
				<td><input type="text" id="oActiveId" />
				</td>
			</tr>
			<tr>
				<td><span style="margin-right:10px">活动标题</span>
				</td>
				<td><input type="text" id="oActiveName" />
				</td>
				<td><span style="margin-right:10px;margin-left:20px">审批状态</span>
				</td>
				<td><select><option selected value="0">待审核</option><option value="1">审核通过</option><option value="-1">审核拒绝</option></select></td>
				<td><button style="margin-left:20px" onclick="searchActives()">查询</button>
				</td>
			</tr>
		</table>
	</div>
	...
	<div
		style="height:350px;width:100%;margin:auto;margion-top:10px;overflow-y:scroll">
		<table id="oAdTable"
